...
COMMENT ON FUNCTION public.custom_access_token_hook(jsonb) IS
  'Adds license, quota, and staff role claims to Supabase access tokens. To create staff manually: update auth.users set raw_app_meta_data = raw_app_meta_data || ''{"role":"owner"}''::jsonb where email = ''owner@example.com'';';
